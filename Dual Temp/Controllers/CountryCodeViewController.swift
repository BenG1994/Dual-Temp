...
//  Dual Temp
//
//  Created by Ben Gauger on 10/29/22.
//
...
class CountryCodeViewController: UIViewController {
    ...
    Country(name: "Congo (Democratic Republic)", code: "CD"),
    Country(name: "Congo (the)", code: "CG"),
    ...
    Country(name: "Equatorial Guinea", code: "CG"),
    ...
    Country(name: "Holy See (the)/Vatican City", code: "VA"),
    ...
    Country(name: "Kyrgzstan", code: "KG"),
    ...
    Country(name: "Norfolk Islands", code: "NF"),
    ...
    Country(name: "Papa New Guinea", code: "PG"),
    Country(name: "Paraguay", code: "PY"),
    Country(name: "Peru", code: "PE"),
    Country(name: "Phillipines", code: "PH"),
    ...
    Country(name: "Republic of North Macedonia", code: "MK"),
    ...
    Country(name: "Saint Martin", code: "MF"),
    ...
    Country(name: "South Georgia", code: "GS"),
    ...
    Country(name: "United States M. Outlying Islands", code: "UM"),
...
extension CountryCodeViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.detailTextLabel?.font = UIFont.systemFont(ofSize: 25.0)
